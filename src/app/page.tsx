        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-lg sm:text-xl text-sage-600 mb-10 max-w-2xl mx-auto animate-slide-up animate-delay-100">
              Nurture your finances with Sprout. Track spending, grow your savings, 
              and watch your wealth blossom over time.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-sage-600 max-w-2xl mx-auto">
              Simple tools to help you understand your money, build healthy habits, 
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="glass-card p-8 rounded-2xl group hover:-translate-y-1 transition-all duration-300">
              ...
              <p className="text-sage-600">
                ...
                with clear, organized transaction history.
              </p>
            </div>
            ...
            <div className="glass-card p-8 rounded-2xl group hover:-translate-y-1 transition-all duration-300">
              ...
              <p className="text-sage-600">
                Manage savings, budgets, allowances, and investments all in one place. 
                Each account with its own balance and history.
              </p>
            </div>
            ...
            <div className="glass-card p-8 rounded-2xl group hover:-translate-y-1 transition-all duration-300">
              ...
              <p className="text-sage-600">
                Your financial data stays secure with encryption and authentication. 
                Download or backup anytime you want.
              </p>
            </div>
          </div>
        </div>
